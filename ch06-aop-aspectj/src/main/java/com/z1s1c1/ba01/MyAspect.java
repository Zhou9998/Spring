...
public class MyAspect {
    ...
    * */
    ...
    /*@Before(value = "execution(public void com.z1s1c1.ba01.SomeServiceImpl.doSome(String ,Integer))")
    public void myBefore(){
        //就是切面要执行的功能代码
        System.out.println("前置通知，切面功能：在目标方法之前输出执行时间："+new Date());
    }*/

    /*@Before(value = "execution(void com.z1s1c1.ba01.SomeServiceImpl.doSome(String ,Integer))")
    public void myBefore(){
        //就是切面要执行的功能代码
        System.out.println("1=============前置通知，切面功能：在目标方法之前输出执行时间："+new Date());
    }*/

    /*@Before(value = "execution(* com.z1s1c1.ba01.*ServiceImpl.*(..))")
    public void myBefore(){
        //就是切面要执行的功能代码
